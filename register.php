...
if (isset($_POST["register"])) {
  ...
  if ($rpass == $password) {
    // $query = "INSERT INTO `users`(`user_fname`, `user_lname`, `user_email`, `user_pass`) VALUES ('$firstname','$lastname','$email','$rpass')";
    $result=mysqli_query($conn,"INSERT INTO `users`(`user_fname`, `user_lname`, `user_email`, `user_pass`) VALUES ('$firstname','$lastname','$email','$rpass')");
            ...
            <div class="p-5">
              ...
              <form action="./register.php" method="POST" class="user">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" name="rpass" class="form-control form-control-user" id="exampleRepeatPassword"
